...
if(isset($_POST['postBtn'])){
    ...
    $sql = "insert into `post` (description,name) values ('$description','$name')";
...
<body>
    ...
    <div class="p-container">
        ...
        <div class="text">
            <form method="post">
            <div class="post">
                <textarea name="post" id="" cols="30" rows="10" placeholder="Write your post" ></textarea>
                <div class="controller">
                <input type="submit" name="postBtn" value="Post" >
                <a href="admin-post-controller.php">See All Post</a>
                </div>
             </div>
            </form>
