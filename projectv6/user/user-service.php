...
<body>
    ...
    <form class="container" action="">
          ...
          <div class="card">
              <div class="card-body">
                  ...
                  <div class="input">
                      <input type="text" name="user" id="name"  value="<?php echo $name ?>"; readonly  placeholder="Enter Full name" required>  
                  </div>
              </div>
          </div>
  ...
  <div class="popup">
          <div class="details">
              <h2>Transition Exchange Rate</h2>
              <div class="text">
                  <p></p>
                  <p></p>
                  <p></p>
              ...
              <button class="cls-btn"><a href="user-checkout.php">Checkout</a></button>
          </div>
    </div>
